...
<form method="POST" action="../operator/tambah-brg.php">
      <div class="container">
        <div class="judul">
          <h1>Edit data</h1>
        </div>
        <div class="input">
          <div class="box1">
            ...
            <div class="nama inp">
              <input type="text" id="id" name="id" disabled value="<?php echo "Auto" ?>"/>
            </div>
        ...
        <a href="tampilkan.php?hal=edit" id="link" >Batal</a>
        </div>
        </form>
