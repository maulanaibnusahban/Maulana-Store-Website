  ...
  <body style="font-family: 'Poppins', sans-serif">
          ...
          <ul class="navbar-nav ms-auto" style="gap: 30px">
            ...
            <li class="nav-item">
              <?php if ($_SESSION['user'] == 'admin'){
                echo "<a class='nav-link' href='kontak.php'>Kontak Masuk</a>";
              } else {
    ...
    <div class="container-2">
      ...
      <div class="card-content">
        <a href="tampilkan.php?hal=beli">
          <div class="card satu">
            <img src="../img/beli-barang.jpg" alt="" height="170px" />
            <p>Beli Barang</p>
            <button>Beli disini</button>
          </div>
        </a>

        <a href="kontak-user.php">
          <div class="card satu">
            <img src="../img/inbox2.png" alt="" height="170px" />
            <p>Hubungi Kami</p>
            <button>Hubungi disini</button>
          </div>
        </a>

        <a href="tampilkan.php?hal=stock"
          ><div class="card tiga">
            <img src="../img/lihat-stock.jpg" alt="" height="170px" />
            <p>Lihat Stock Barang</p>
